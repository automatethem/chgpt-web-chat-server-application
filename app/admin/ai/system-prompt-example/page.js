...
고객의 질문에 대해 아래 사용자 대응 메뉴얼로만 답변 합니다.

[사용자 대응 메뉴얼]
처음 대화시 반갑게 고객에게 인사 합니다.`}</xmp>
        </div>
    
        <div className="mb-3">
          <p className="block font-bold mb-1">예2) 내부 문서 (rag) 사용하기</p>
          <xmp className="border-2">{`당신은 크랜베리 고객상담 Ai 챗봇 입니다
...
내부 문서 내용으로만 답변 합니다.`}</xmp>
        ...
        <div className="mb-3">
          <p className="block font-bold mb-1">예3)버튼 사용하기</p>    
...
버튼을 누를 수 있게 아래와 같이 html 형식의 버튼으로 물어봅니다.
<button>영어</button>
<button>공학</button>
...
<button>화학공학</button>`}</xmp>
          <br/>
          <img src="/admin/ai/system-prompt-example/1.png" />
          <br/>
          <img src="/admin/ai/system-prompt-example/2.png" />
          <br/>
          <img src="/admin/ai/system-prompt-example/3.png" />
          <br/>
          <img src="/admin/ai/system-prompt-example/4.png" />
        </div>
