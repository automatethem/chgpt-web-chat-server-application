...
function Page() {
  ...
  */
  ...
  <p className="text-red-500">{error.message}</p>
        ...
        <form className="form-control m-2 items-center" onSubmit={(e) => { setIsTyping(true); handleSubmit(e); setDisplayExamples(false); }}>
          <div className="join w-full max-w-screen-md relative">
            ...
            <button className="btn btn-square" type="submit" id="submitButton" disabled={isLoading}>
